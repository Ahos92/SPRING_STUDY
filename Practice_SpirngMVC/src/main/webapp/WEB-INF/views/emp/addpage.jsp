...
<form action="./add" method="POST">
	...
	<div class="input-group input-group-sm mb-3">
	  ...
	  <input type="text" class="form-control" name="email" aria-describedby="inputGroup-sizing-sm">
	</div>
	
	<div class="input-group input-group-sm mb-3">
	  <span class="input-group-text" id="inputGroup-sizing-sm">Phone_number</span>
	  <input type="text" class="form-control" name="phone_number" aria-describedby="inputGroup-sizing-sm">
	</div>
	
	<div class="input-group input-group-sm mb-3">
	  <span class="input-group-text" id="inputGroup-sizing-sm">Hire_date</span>
	  <input type="date" class="form-control" name="hire_date" aria-describedby="inputGroup-sizing-sm">
	</div>
	...
	<div class="input-group input-group-sm mb-3">
	  ...
	  <input type="text" class="form-control" name="salary" aria-describedby="inputGroup-sizing-sm">
	</div>
	
	<div class="input-group input-group-sm mb-3">
	  <span class="input-group-text" id="inputGroup-sizing-sm">Commission_pct</span>
	  <input type="text" class="form-control" name="commission_pct" aria-describedby="inputGroup-sizing-sm">
	</div>
	
	<div class="input-group input-group-sm mb-3">
	  <span class="input-group-text" id="inputGroup-sizing-sm">Manager_id</span>
	  <input type="text" class="form-control" name="manager_id" aria-describedby="inputGroup-sizing-sm">
	</div>
	
	<div class="input-group input-group-sm mb-3">
	  <span class="input-group-text" id="inputGroup-sizing-sm">Department_id</span>
	  <input type="text" class="form-control" name="department_id" aria-describedby="inputGroup-sizing-sm">
	</div>
